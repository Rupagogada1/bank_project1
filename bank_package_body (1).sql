CREATE OR REPLACE PACKAGE BODY AXIS_BANK IS
...
BEGIN
 ...
 WHEN OTHERS THEN
  NULL;
END PN_ADD_CUST_CONTACT;


PROCEDURE PN_DEL_CUST(P_BANK_CUST_ID BANK_CUST.CUST_ID%TYPE) IS
BEGIN
 DELETE BANK_CUST WHERE BANK_CUST.CUST_ID=P_BANK_CUST_ID;
 --COMMIT;
END PN_DEL_CUST;

PROCEDURE PN_DEL_CUST(P_CUST_FIRST_NAME BANK_CUST.CUST_FIRST_NAME%TYPE) IS
BEGIN
 DELETE BANK_CUST WHERE CUST_FIRST_NAME=INITCAP(P_CUST_FIRST_NAME);
 --COMMIT;
END PN_DEL_CUST;

PROCEDURE PN_ADD_SB_ACCOUNT (
...
EXCEPTION
  ...
  WHEN OTHERS THEN
  NULL;
END PN_ADD_SB_ACCOUNT;


PROCEDURE PN_SB_DEPOSIT (P_TRANS_ACC_NO BANK_TRANSACTION.TRANS_ACC_NO%TYPE,
...
PROCEDURE PN_SB_WITHDRAW (P_TRANS_ACC_NO BANK_TRANSACTION.TRANS_ACC_NO%TYPE,
                          P_TRANS_DESC BANK_TRANSACTION.TRANS_DESC%TYPE,
                          P_TRANS_AMT BANK_TRANSACTION.TRANS_AMT%TYPE) IS
V_COUNT NUMBER;
